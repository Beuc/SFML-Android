...
////////////////////////////////////////////////////////////
// Android-specific : defines the android_main entry function,
// so that developers can use the standard main function
// even in an Android project, and keep a portable code
////////////////////////////////////////////////////////////
...
void android_main(struct android_app* app) {
  ...
  /* Call user's main */
  {
    ...
    main(1, argv);  // not a real main(), but a mere function in the
		    // .so, you can ignore the compiler warning
  }
